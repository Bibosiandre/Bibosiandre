...
<a>&nbsp;&nbsp;Привет👋! Меня зовут Владислав, я backend-программист с опытом во frontend разработке. Имею опыт в проектировании веб-приложений(клиент-сервер) и интерфейсов UX/UI, активно испольузую стек HTML-CSS-JS. Знаком с фреймворками React и VueJS и многими другими, а также понимаю синтаксис PHP. </a><br> 
&nbsp;&nbsp;Расширяю навыки в backend с Python и C#, а также изучаю работу с базами данных в том числе анализ данных и написание запросов SQL. Помимо разработки занимаюсь обслуживаем и изучением особенностей серверного оборудования для ЦОД, СХД и дополнительно работаю в 1С.</a><br>
<a>&nbsp;&nbsp;Целью является стать Project Manager или Team Lead и создавать качественные решения. В будущем хотел бы заниматься ведением проектов</a><br>
